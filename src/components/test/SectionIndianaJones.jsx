...
class SectionIndianaJones extends Component {
  ...
  fetchShowFilm = async () => {
    try {
      const response = await fetch("https://www.omdbapi.com/?apikey=ed5ee985&type=movie&s=indiana+jones");
    ...
    return(
      <section>
        <div className="films mb-5">
          <Container>
          <h2 className="mb-3 h4">Indiana Jones</h2>
...
export default SectionIndianaJones;