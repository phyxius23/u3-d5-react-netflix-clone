      ...
      <Container className="container-profile custom-color">
        <Row>
          ...
          <Col xs={12} className="d-flex justify-content-center">
            <Button variant="outline-secondary" className="mx-2">SAVE</Button>
            <Button variant="outline-secondary" className="mx-2">CANCEL</Button>
            <Button variant="outline-secondary" className="mx-2">DELETE PROFILE</Button>
          </Col>
